			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<input class="btn btn-primary form-control" type="submit"
						 name="submit" id="submit" value="Đăng ký" disabled />
				</div>
			</div>
		</form>
	</div>
	...
	<script>
		function kiemTraMatKhau(){
			...
			if(MatKhau!=MatKhauNhapLai){
				document.getElementById("msg").innerHTML = "Mật khẩu ko chính xác";
				return false;
			}else{
		...
		function kiemTraDieuKhoan(){
			...
			dangky_btn = document.getElementById("submit");
			
			if(dongYDieuKhoan.checked == true){
				dangky_btn.removeAttribute("disabled");
			}else{
				dangky_btn.setAttribute("disabled","disabled");
			}
		}
	</script>
</body>
